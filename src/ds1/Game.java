...
public abstract class Game{
	...
	// hash for the game tree nodes
	// map board hash-strings to nodes in the tree
	...
	/**
	 * hashes a bame board b, returning a string representation of it.
	 * @since 3/27/2014
	 */
	...
	/**
	 * Given a game board b, returns either the winner of the game
	 * starting from that board, or TwoPlayer.CONTINUE if the board
	 * represents a game not yet won.
	 */
	abstract int evaluateBoard(Object b);

	/**
	 * Given a game board b, returns the player whose turn it is
	 */
